...
export class DaoChatView extends CrLitElement {
  static override get properties() {
    return {
      ...
      pendingPageAttachment_: {type: Object, state: true},
      pendingSelection_: {type: Object, state: true},
      pendingElementContexts_: {type: Array, state: true},
      elementPicking_: {type: Boolean, state: true},
      elementPickMode_: {type: String, state: true},
      skillPickerVisible_: {type: Boolean, state: true},
      skillPickerSkills_: {type: Array, state: true},
      skillPickerIndex_: {type: Number, state: true},
      skillPickerAnchor_: {type: Object, state: true},
      skillCatalogPrompt_: {type: String, state: true},
