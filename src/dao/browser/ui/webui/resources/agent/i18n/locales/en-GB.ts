...
const dict: Dictionary = {
  ...
  'chat.compact.auto_notice': 'Dao auto-compacted this chat at {percent}% context · {count} messages summarised',
  ...
  'chat.attach.element_screenshot.dismiss_title': 'Don\'t attach this screenshot',
  'chat.attach.element_screenshot.pick_tooltip': 'Screenshot an element from the page',
  'chat.attach.element_screenshot.pick_active_tooltip': 'Cancel element screenshot',
  'chat.attach.element_screenshot.pick_selected': 'Added element screenshot',
  'chat.attach.element_screenshot.pick_cancelled': 'Element screenshot cancelled',
  ...
  'chat.proactive.never_here_aria': 'Don\'t suggest on this page again: {title}',
  ...
  'chat.proactive.default_context_disclosure': 'Dao will only attach the current page after you click Run.',
  'chat.proactive.default_expected_outcome': 'Help you make progress on this page.',
  'chat.proactive.context.captures_after_run': 'Dao will only attach visible page text after you click Run.',
  'chat.proactive.context.no_capture_before_run': 'No page text is captured before Run.',
  'chat.proactive.reason.sensitive_page': 'This page looks sensitive, so proactive help stays off until you ask.',
  'chat.proactive.reason.fatigue': 'Recent dismissals on this domain suggest staying quiet for now.',
  'chat.proactive.reason.typing': 'You are actively typing, so Dao will wait until the page is less interruptible.',
  'chat.proactive.reason.missing_action_evidence': 'The page matches this action, but Dao cannot see enough evidence for a useful result yet.',
  'chat.proactive.reason.poor_personal_fit': 'You have skipped this personalised suggestion often, so Dao will stay quiet here.',
  'chat.proactive.reason.insufficient_content': 'The page matches this scenario, but there is not enough visible content yet.',
  'chat.proactive.reason.structured_content': 'The page matches this scenario and shows structured content that should produce a useful result.',
  'chat.proactive.reason.matched_structure': 'The page matches this scenario and has enough visible structure for a useful result.',
  'chat.proactive.expected.review_code': 'Produces a concise review with issues, suggestions, and an overall assessment.',
  'chat.proactive.expected.analyze_issue': 'Produces a short issue summary with key discussion points and next steps.',
  'chat.proactive.expected.analyze_progress': 'Produces a status readout with blockers, risks, and priority recommendations.',
  'chat.proactive.expected.summarize_doc': 'Produces a quick summary of the page with key concepts and caveats.',
  'chat.proactive.expected.extract_answer': 'Produces the likely answer with important caveats pulled into one place.',
  'chat.proactive.expected.default': 'Produces a focused result for this page.',
  'chat.proactive.attachment_title': 'Proactive suggestion',
  'chat.proactive.title.review_code': 'Review this PR',
  'chat.proactive.title.analyze_issue': 'Analyse this issue',
  'chat.proactive.title.analyze_progress': 'Analyse project progress',
  'chat.proactive.title.summarize_doc': 'Summarise this doc',
  ...
  'dream.page.source_domains_confirm': 'Add {domain} to the blacklist? Future Dream analysis will ignore it.',
  ...
  'dream.page.source_domains_empty': 'No domains were captured for this report. Rerun it to refresh choices.',
  ...
  'settings.tools.catalog_load_failed': 'Tool descriptions could not be loaded.',
  ...
  'settings.tools.jina_api_key_desc': 'Optional. In Auto mode, Dao uses Jina Search before DuckDuckGo HTML when this key is set.',
